...
<Tabs>
  <Tab title="역할 기반 (권장)">
    ...
    <Steps>
      ...
      <Step title="연결 완료">
        역할 ARN을 CloudThinker에 붙여 넣고 필요하면 기본 리전을 선택한 후 **Connect**를 클릭하세요. CloudThinker가 역할을 검증하고 **Connected** 상태를 표시합니다.
      </Step>
    </Steps>
...
| **기본 AWS 리전 (선택 사항)** | 연결의 시작 리전입니다. 에이전트는 접근 권한과 사용자가 지정한 범위 내에서 다른 리전을 사용할 수 있습니다. | `us-east-1` |
