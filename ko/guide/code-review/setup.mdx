...
Git 공급자를 한 번 연결하면 선택한 저장소의 모든 새 풀 리퀘스트가 자동으로 AI 리뷰를 받습니다. Review가 처음이라면 먼저 [개요](/ko/guide/code-review/overview)를 읽어보세요.
...
<Steps>
  <Step title="Review 열기">
    탐색 메뉴에서 **Review**로 이동하세요.

  </Step>

  <Step title="설정 시작">
    **Get Started with Review**를 클릭하여 설정 마법사를 여세요.
  ...
  <Step title="저장소 선택">
    ...
    **성공 기준:** Review 대시보드에 저장소가 표시됩니다 — CloudThinker가 이제 풀 리퀘스트와 머지 리퀘스트를 모니터링합니다.
