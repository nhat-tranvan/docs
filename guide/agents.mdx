...
When a chat turn streams for more than one minute, a small Anna game appears above the message input. Anna Dash lets you jump over bugs; Bug Blaster lets you shoot them. One game is selected randomly for each wait.

Select **Play**, then use the small **Jump** or **Fire** control. You can also press Space while that control has focus. Typing your next message pauses the game and keeps your draft. Pause, restart or dismiss the game whenever you want.
