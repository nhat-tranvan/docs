---
title: Resources
description: Discover AWS and GCP cloud assets, scope scans by tags, and act on cost, security, and performance findings from one inventory.
icon: cubes
---
...
<Note>This legacy surface is no longer in the current product navigation. Its `/resources` route remains available while it is retired.</Note>
...
<Steps>
  <Step title="Launch discovery">
    Open the legacy `/resources` route directly, click **Connect** for your cloud (AWS shown here), and start **Resource Discovery**. The banner shows the flow: connect, run the first scan (~30s), then automate.
