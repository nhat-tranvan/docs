...
CloudKeepers are autonomous monitors that enforce cost, security, and performance guardrails across every connected cloud account and Kubernetes cluster.

<Note>This legacy surface is no longer in the current product navigation. Its `/resources/cloudkeepers` route remains available while it is retired. Use [Optimize Findings](/guide/cost-optimization/recommendations) for the current cost-finding workflow.</Note>
...
<Steps>
  <Step title="Open Keepers">
    Open the legacy `/resources/cloudkeepers` route directly. It walks you through three steps: connect a cloud account, enable keepers, and run your first detection scan. Click **Enable Your First Keepers** to begin.
