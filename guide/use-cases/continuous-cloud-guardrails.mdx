...
<Steps>
  <Step title="Enable keepers">
    ...
    <Frame>
      <img src="/images/infrastructure/cloudkeepers/01-onboarding-landing.jpg" alt="CloudKeepers onboarding page with Enable Your First Keepers CTA and value cards" />
    </Frame>
  ...
  <Step title="Configure keepers and schedules">
    ...
    <Frame>
      <img src="/images/infrastructure/cloudkeepers/02-setup-wizard.jpg" alt="Two-step setup wizard with keeper selection and per-rule configuration" />
    </Frame>
  ...
  <Step title="Review the dashboard">
    ...
    <Frame>
      <img src="/images/infrastructure/cloudkeepers/03-keeper-dashboard.jpg" alt="AWS Cost Optimization dashboard with stat cards and findings over time chart" />
    </Frame>
  ...
  <Step title="Triage findings">
    ...
    <Frame>
      <img src="/images/infrastructure/cloudkeepers/04-keeper-findings.jpg" alt="Findings Kanban board with pending finding card showing savings and risk" />
    </Frame>
  ...
  <Step title="Review detection runs">
    ...
    <Frame>
      <img src="/images/infrastructure/cloudkeepers/05-keeper-runs.jpg" alt="Runs tab showing completed detection run with summary and findings count" />
    </Frame>
  ...
  <Step title="Configure detection rules">
    ...
    <Frame>
      <img src="/images/infrastructure/cloudkeepers/06-keeper-settings.jpg" alt="Settings tab with cron schedule and detection rule toggles" />
    </Frame>
