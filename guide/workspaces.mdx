...
A workspace is an isolated environment inside your [organization](/guide/organization) that holds its own [agents](/guide/agents), [connections](/guide/connections/overview), and [knowledge bases](/guide/knowledge). Every account gets a default organization and workspace at signup; billing and member management happen at the organization level.
...
| Agent Configuration | [Connections](/guide/connections/overview), [Skills](/guide/skills/overview), [Agents](/guide/agents/customize), [Knowledge](/guide/knowledge) |
| Workflow | [Commands](/guide/commands), [Approval](/guide/approval), [Automations](/guide/automation/automations) |
