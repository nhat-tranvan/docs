...
<Accordion title="Essential Read-Only Policies">
```json
{
  "Version": "2012-10-17",
  "Statement": [
...
<Accordion title="GCP Read-Only Roles">
- **Viewer**: Basic read access to all resources
- **Monitoring Viewer**: Access to monitoring and logging data  
- **Security Reviewer**: Read access to security configurations
- **Compute Viewer**: Enhanced access to Compute Engine details
- **Storage Object Viewer**: Read access to Cloud Storage objects
</Accordion>
