...
<Steps>
  <Step title="Open DRE integrations">
...
For supported webhooks, you can enable automatic RCA and set a minimum severity. The workspace-level **DRE auto-investigates** setting still controls whether eligible Incidents start RCA automatically.
