...
<CardGroup cols={3}>
  <Card title="Datadog" icon="/images/icons/datadog.svg">Monitors, alerts, anomaly detections</Card>
  <Card title="Grafana" icon="/images/icons/grafana.svg">Alert rule firings and annotations</Card>
  <Card title="New Relic" icon="circle-dot">Incidents and NRQL alert results</Card>
  <Card title="PagerDuty" icon="/images/icons/pagerduty.svg">Incident and alert webhooks</Card>
