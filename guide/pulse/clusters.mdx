...
description: "Understand how Pulse groups signals into clusters and cuts noise through seven automatic suppression layers."
icon: layer-group
---
...
<CardGroup cols={2}>
  <Card title="Pulse analytics" icon="chart-bar" href="/guide/pulse/analytics">
    Measure signal volume, noise reduction, cluster resolution time, and source conversion rates.
  </Card>
  <Card title="Pulse setup" icon="bolt" href="/guide/pulse/setup">
