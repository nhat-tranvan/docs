...
| Suppress | Apply the [eight suppression layers](/guide/pulse/clusters#noise-suppression): deduplication, rate limits, snoozes, prior verdicts, noise patterns, flapping checks, cascade suppression, and severity normalization. |
...
Pulse creates the Incident before RCA begins. Turning **On Duty** (automatic investigation) off pauses automatic analysis; it does not stop detection or Incident creation.
