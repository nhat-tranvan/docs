...
Business and Enterprise plans support SSO via **SAML 2.0** and **OpenID Connect (OIDC)**, working with providers like Okta, Azure AD, OneLogin, and Google Workspace.
...
<CardGroup cols={2}>
  <Card title="Set Up SSO" icon="key" href="/guide/security/sso">
    Configure SAML or OIDC single sign-on
  </Card>
  <Card title="Set Up SCIM" icon="users-gear" href="/guide/security/scim">
