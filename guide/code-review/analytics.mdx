...
description: "Use Code Review Analytics to track review coverage, recurring findings, trends, and repository reports."
icon: chart-mixed
---
...
<CardGroup cols={2}>
  <Card title="Code Review Setup" icon="settings" href="/guide/code-review/setup">
  ...
  <Card title="Code Review Overview" icon="code" href="/guide/code-review/overview">
