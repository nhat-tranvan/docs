...
Extensions connect your issue trackers to CloudThinker's code review agent. When the agent detects issue references in your merge request or pull request (MR/PR) description or branch name, it fetches the linked ticket details and reviews the change against them.
...
<Steps>
  ...
  <Step title="Check the Extensions page">
    Go to **Review → Extensions** to verify the connection status shows "Connected"
  </Step>
