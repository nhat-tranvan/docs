...
5. **Track** — when a linked ticket provides acceptance criteria, the review records a ticket-compliance verdict. When you push a fix, the next review verifies it, and every finding feeds the [Leaderboard](/guide/code-review/leaderboard).

<Frame>
  <img src="/images/use-cases/code-review-automation/01-security-code-review-jira-ticket.jpg" alt="Legacy Code Review example showing a Jira ticket linked to a finding" />
</Frame>
<p style={{textAlign: 'center', fontSize: '0.9em', color: '#666', marginTop: '8px'}}>Legacy Code Review example showing a Jira ticket linked to a finding</p>
