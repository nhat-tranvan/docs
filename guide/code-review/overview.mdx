...
<CardGroup cols={2}>
  ...
  <Card title="Convention Rules" icon="scroll" href="/guide/code-review/convention-rules">
    Keep reviews aligned with your team's coding conventions, from your own convention files and rules learned from past reviews
  </Card>
