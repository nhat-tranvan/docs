...
<Frame>
  <img src="/images/use-cases/code-review-automation/01-security-code-review-jira-ticket.jpg" alt="Legacy Review example showing a Jira ticket linked to a finding" />
</Frame>
<p style={{textAlign: 'center', fontSize: '0.9em', color: '#666', marginTop: '8px'}}>Legacy Review example showing a Jira ticket linked to a finding</p>
