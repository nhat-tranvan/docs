...
5. **Track** — critical findings auto-create Jira tickets when [Atlassian](/guide/connections/atlassian) is connected. When you push a fix, the next review verifies it and updates the ticket, and every finding feeds [Analytics](/guide/code-review/analytics).
