...
CloudThinker agents can run work without a live prompt through scheduled tasks and Pulse. Manual or Auto is a workspace setting, while Tool Permissions control individual connection tools.
