...
CloudThinker agents can run work without a live prompt through Automations and Pulse. Manual or Auto is a workspace setting, while Tool Permissions control individual connection tools.

## Why autonomous operations

- **Routine work runs itself.** Automations run recurring checks or a future one-time run without someone remembering.
...
|---------|------------------------|------------|
| **Automations** | Run a stored prompt on a recurring schedule or at one future time | [Automations](/guide/automation/tasks) |
