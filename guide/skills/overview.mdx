...
1. **Create** — write a skill manually, describe it in plain language for CloudThinker to generate, or upload a standalone `.md` file or `.zip` package.
...
| --- | --- | --- |
| Create custom skills | Build workspace-private skills manually, generate them with CloudThinker, or upload a standalone `.md` or `.zip` package | [Custom skills](/guide/skills/custom-skills) |
...
| Format | A required `SKILL.md` entrypoint, uploaded as a standalone `.md` file or in a `.zip` package | Uploaded files or crawled websites |
