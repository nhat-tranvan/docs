---
title: Custom Skills
description: "Create, enable, and attach workspace skills to Chat, Code Review, Incident, and Assessment"
  ...
  <Step title="Create, write, or upload the skill">
    <Tabs>
      ...
      <Tab title="Upload a skill">
        Upload a standalone `.md` file or a `.zip` package. A package must contain `SKILL.md` and can include permitted `scripts/`, `schemas/`, and `references/` directories.

        A standalone upload without `name` frontmatter derives its name from the filename. See [Skill format](/guide/skills/skill-format) for package and metadata rules.
      </Tab>
    </Tabs>
