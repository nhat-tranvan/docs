...
<Info>
  Configure code review destinations and severity thresholds in the notification matrix at **Settings > Notifications > Code Review / Pipeline Monitoring**. See [Notifications Center](/guide/notifications) for details.
</Info>
