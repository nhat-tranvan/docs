...
<Note>
  Assessment is available on the **Scale** plan and above. Only resources that appear in your **Resources** inventory can be assessed — make sure discovery has run first.
</Note>
