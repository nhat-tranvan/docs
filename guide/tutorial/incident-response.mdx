---
title: "Deep Response Engine Setup"
...
<CardGroup cols={2}>
  <Card title="AgenticOps" icon="comments" href="/guide/tutorial/agenticops">
    Role-based quick wins, the @agent #tool syntax, and the Detect → Analyze → Resolve → Validate loop
  </Card>
  <Card title="Code Review" icon="code-pull-request" href="/guide/tutorial/code-review">
    AI-powered PR reviews with production and incident context
  </Card>
  <Card title="CostOps" icon="dollar-sign" href="/guide/tutorial/cloudkeepers">
    Autonomous cost monitoring with scheduled scans and approval-gated remediation
  </Card>
  <Card title="Deep Response Engine" icon="triangle-exclamation" href="/guide/tutorial/incident-response">
    Pulse signal intelligence feeding agent-led incident investigation
  </Card>
</CardGroup>
