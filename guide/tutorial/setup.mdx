...
<Steps>
  ...
  <Step title="Create Your Workspace (Optional)">
  ...
  <Step title="Upgrade Your Plan">
    Go to [**Admin settings** > **Billing** > **Upgrade Plan**](https://app.cloudthinker.io/admin-settings/billing/plans) tab to review your plan.

    CloudThinker uses **per-seat billing** — each seat grants a monthly credit allocation and one active-member slot.

    | Plan | Price | Min seats | Credits / seat | Workspaces | Best for |
    |------|-------|-----------|----------------|------------|----------|
    | **Team** | $25/seat/month | 1 | 200 | Up to 5 | Small teams running real operations |
    | **Business** | $39/seat/month | 5 | 400 | Up to 20 | Growing orgs needing SSO/SCIM, audit logging, and 99.9% SLA |
    | **Enterprise** | Custom | 50 | Custom (PAYG) | Unlimited | Self-hosted / BYOC, 99.95% SLA, dedicated support |

    To upgrade:
    1. Open the [**Upgrade Plan**](https://app.cloudthinker.io/admin-settings/billing/plans) tab
    2. Select your plan
    3. Add the number of seats your team needs
    4. Enter payment details

    <Tip>
      Start with **Team** — it includes a 14-day free trial — and move to Business when you need SSO, audit logging, or more than 5 workspaces. You can add seats at any time without changing plans.
    </Tip>
  </Step>
...
<Card title="AgenticOps" icon="comments" href="/guide/tutorial/vibeops">
