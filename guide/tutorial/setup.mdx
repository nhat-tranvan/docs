...
<Steps>
  ...
  <Step title="Upgrade Your Plan">
    ...
    CloudThinker uses **per-seat billing** — each seat grants a monthly credit allocation and one active-member slot. See [Pricing & Plans](/guide/billing/pricing) for the full comparison of plans, credits, seats, and features.
    ...
    <Tip>
      Start with **Team** — it includes a 14-day free trial — and move to **Scale** when you need SSO, audit logging, or more workspaces. You can add seats at any time without changing plans.
    </Tip>
  </Step>
...
<Card title="AgenticOps" icon="comments" href="/guide/tutorial/agenticops">
