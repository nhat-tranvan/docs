    ...
    <Tabs>
      ...
      <Tab title="SRE / On-call">
        ...
        **Quick win — investigate an active alert:**
        ...
        Anna delegates to the relevant specialists, gathers evidence in parallel, and returns a ranked list of likely causes with the evidence behind each.
...
<CardGroup cols={2}>
  ...
  <Card title="Resolve" icon="triangle-exclamation" href="/guide/pulse/setup">
