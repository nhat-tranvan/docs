---
title: "Code Review"
description: "Connect your repositories and get AI-powered code reviews on every pull request — catching bugs, vulnerabilities, and quality issues automatically."
...
<Steps>
  <Step title="Navigate to Code Review Settings">
    ...
    You'll see options to connect **GitHub** or **GitLab** repositories.
  </Step>
...
The Leaderboard scores each developer by balancing **Quality** (AI review scores) and **Impact** (code complexity) — so it rewards engineers who ship robust code, not just those who ship the most lines.
