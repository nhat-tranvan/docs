...
<<<<<<< HEAD
The Leaderboard scores each developer by balancing **Quality Score** and **Impact** to produce a **Contribution Score** — rewarding engineers who ship robust code, not just those who ship the most lines.
=======
