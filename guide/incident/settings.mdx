...
Open **Resolve → Settings** to control when Resolve investigates and how it treats new evidence. These settings affect RCA behavior; they do not disable Pulse detection or Incident creation.
