...
**On hold** is not terminal. It pauses the investigation when Anna needs information, access, or a decision. The Incident enters **Needs your decision** until a person supplies what RCA needs to continue.

The Investigation queue groups work by what needs attention: **Needs your decision**, **AI is handling**, **Resolved**, and **Dismissed**. Incidents with a **Not found** result do not remain in the queue.
