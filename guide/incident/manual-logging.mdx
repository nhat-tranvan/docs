...
<Steps>
  ...
  <Step title="Create and investigate">
    ...
    Review the context, then click **Investigate** to start RCA. Manual investigation works even when **Resolve auto-investigates** is off.
...
| You can still correct Incident metadata | The Open AI Conversation action opens the saved RCA conversation | A matching runbook may wait for approval or run if policy allows it |
