...
<Note>
  **Available since May 2026** — read the [launch announcement](https://cloudthinker.io/blogs/introducing-deep-response-engine) for the rename context, the Pulse pillar, Incident Memory v1, auto-RCA, and the hardened 15+-platform webhook suite.
</Note>
