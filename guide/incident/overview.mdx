...
<Card title="Webhook Integrations" icon="webhook" href="/incident/webhook-integrations">
...
Once incidents are flowing in, explore the [Root Cause Analysis](/incident/root-cause-analysis) workflow to understand how AI agents investigate and prioritize remediation steps. For advanced topology-based impact analysis, see [Incident & Topology Integration](/incident/incident-topology-integration).
