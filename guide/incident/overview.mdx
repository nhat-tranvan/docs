...
description: "Understand how DRE turns noisy operational events into investigated incidents, approved actions, and reusable lessons."
...
<CardGroup cols={2}>
  ...
  <Card title="Set DRE behavior" icon="sliders" href="/guide/incident/settings">
