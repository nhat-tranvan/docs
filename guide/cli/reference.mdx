...
Put `--url` and `--workspace` before the subcommand. `--skill`, help, and version work without authentication.
...
| `--skill [MODULE]` | Print the bundled agent guidance and exit. Modules: `auth`, `chat`, `review`; omit the module for the index |
