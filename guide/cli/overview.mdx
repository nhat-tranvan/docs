...
| `cloudthinker` | Runs the local coding agent, the same as `cloudthinker agent` |
| `cloudthinker agent` | Run the local coding agent in the current directory, see [Agent CLI](/guide/cli/agent) |
