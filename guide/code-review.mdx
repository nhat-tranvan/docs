...
<CardGroup cols={2}>
  <Card title="Good Practices" icon="check" color="#28A745">
    - Write clear PR descriptions - Keep PRs focused and small - Review AI
    suggestions carefully - Address high-severity issues first - Use consistent
    coding standards
  </Card>
  <Card title="Avoid These" icon="xmark" color="#DC3545">
    - Ignoring AI recommendations - Creating massive PRs - Skipping security
    warnings - Merging without reviewing findings - Disabling reviews on
    critical repos
  </Card>
</CardGroup>
