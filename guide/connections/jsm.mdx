...
Incident sync runs as an outcome in [Resolve](/guide/incident/overview). When a responder acknowledges the alert in JSM, the matching incident moves to **Acknowledged** — a responder owns it, and analysis has not started.
