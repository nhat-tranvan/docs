...
<CardGroup cols={3}>
  ...
  <Card title="Kafka" icon="/images/icons/integrations/apache-kafka.svg" href="/guide/connections/kafka">
...
<CardGroup cols={3}>
  <Card title="Flespi" icon="satellite-dish" href="/guide/connections/flespi">
