...
```text
@alex list open Better Stack incidents and current on-call for the connected team
```

### Example prompts

```text
@alex #recommend follow-ups for Better Stack incidents from the last 24h
@alex #visualize 5xx errors by status code from api-gateway logs over the last hour
