...
An [Automation](/guide/automation/tasks) reruns its instructions in a new conversation. It may create a fresh Artifact; it does not refresh an existing Artifact in place.
...
| Correlate operational signals | Anna combines health, performance, and cost data across clouds in one view | [Resolve](/guide/incident/root-cause-analysis) |
...
| Visualize dependencies | Explore resource relationships and blast radius in an incident report | [Resolve](/guide/incident/root-cause-analysis) |
...
| Start from inbound webhooks | An inbound webhook starts a conversation or Resolve flow; it does not deliver Artifact events to external systems | [Webhooks](/guide/webhooks/overview) |
