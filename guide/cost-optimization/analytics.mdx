...
**Updated \<date\>** sits in the page header beside the Daily refresh control, not in the spend summary. It reports when CostOps last ingested billing rows for the connection.
