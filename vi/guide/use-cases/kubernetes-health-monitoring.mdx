...
- **[Tác vụ theo lịch](/vi/guide/automation/tasks)** có thể chạy lại phân tích này trước khi kỹ sư trực bị gọi.
...
<CardGroup cols={2}>
  ...
  <Card title="Cụm Pulse" icon="diagram-project" href="/vi/guide/pulse/clusters">
    Nhóm các tín hiệu Kubernetes liên quan trước khi chúng trở thành incident
  </Card>
  <Card title="Tác vụ và lịch chạy" icon="calendar-check" href="/vi/guide/automation/tasks">
