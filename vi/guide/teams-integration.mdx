...
Khi AI Review hoàn thành, CloudThinker gửi thông báo Adaptive Card đến kênh Teams đã cấu hình của bạn. Thẻ bao gồm:
...
<Info>
  Cấu hình kênh Teams nào nhận thông báo Review và đặt ngưỡng mức độ nghiêm trọng trong **Settings > Notifications > Review / Pipeline Monitoring**. Xem [Notifications Center](/vi/guide/notifications) để biết chi tiết.
</Info>
