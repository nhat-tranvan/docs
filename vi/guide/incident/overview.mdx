...
Resolve là mô-đun vòng đời sự cố của CloudThinker. Nó xử lý mọi sự kiện từ tín hiệu đầu tiên đến sự cố đã giải quyết — giảm nhiễu, leo thang, phân tích nguyên nhân gốc rễ, khắc phục, và ghi nhớ.

Hầu hết stack giám sát cho bạn biết có gì đó sai và dừng lại ở đó. Resolve cho bạn biết tại sao: [Pulse](/vi/guide/pulse/overview) lọc và tương quan các tín hiệu trước khi thông báo cho bất kỳ ai, và Incident bắt đầu điều tra ngay khi một cluster leo thang — thường là trước khi kỹ sư trực mở laptop.
