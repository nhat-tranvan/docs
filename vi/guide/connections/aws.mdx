  ...
  <Tab title="Dựa trên Role (Khuyến nghị)">
    ...
    <Steps>
      ...
      <Step title="Hoàn tất kết nối">
        Dán Role ARN vào CloudThinker, chọn region mặc định nếu cần và nhấp **Connect**. CloudThinker xác minh role và hiển thị trạng thái **Connected**.
      </Step>
    </Steps>
...
| **Region AWS mặc định (không bắt buộc)** | Region bắt đầu cho kết nối. Agent có thể dùng region khác trong phạm vi quyền truy cập và giới hạn bạn chỉ định. | `us-east-1` |
