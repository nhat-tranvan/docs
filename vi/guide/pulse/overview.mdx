...
| Leo thang thành sự cố | Đề bạt bất kỳ cluster nào thành sự cố đầy đủ với phân tích nguyên nhân gốc rễ tự động | [Deep Response Engine](/vi/guide/incident/overview) |
...
<CardGroup cols={2}>
  ...
  <Card title="Deep Response Engine" icon="arrow-right" href="/vi/guide/incident/overview">
