...
<CardGroup cols={2}>
  <Card title="Cyber" icon="shield-halved" href="/vi/guide/security/pentest">
    Để Oliver kiểm thử một App mục tiêu và xác minh từng phát hiện bằng bằng chứng có thể tái hiện
  </Card>
  <Card title="Review" icon="code-pull-request" href="/vi/guide/code-review/overview">
    Phát hiện vấn đề bảo mật trên pull request trước khi phát hành
  </Card>
