...
<Steps>
  <Step title="Mở Code Review">
    ...
    <Frame>
      <img src="/images/code-review/setup_step_1_onboarding.png" alt="Khởi động Code Review" />
    </Frame>
  </Step>
  ...
  <Step title="Bắt đầu thiết lập">
    ...
    <Frame>
      <img src="/images/code-review/setup_step_1_setuprovider.png" alt="Thiết lập Code Review - Chọn Provider" />
    </Frame>
  </Step>
  ...
  <Step title="Chọn provider">
    ...
    <Frame>
      <img src="/images/code-review/setup_step_1_connectprovider.png" alt="Chọn Git Provider" />
    </Frame>
  </Step>
  ...
  <Step title="Chọn kho">
    ...
    <Frame>
      <img src="/images/code-review/setup_step_1_select_repo.png" alt="Chọn Kho" />
    </Frame>
    ...
    **Trạng thái thành công:** Các kho của bạn xuất hiện trong dashboard Code Review — CloudThinker hiện đang giám sát pull request và merge request của chúng.
    ...
    <Frame>
      <img src="/images/code-review/setup_step_1_complete_setup.png" alt="Thiết lập thành công" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Kiểm tra trạng thái trong CloudThinker">
    ...
    <Frame>
      <img src="/images/code-review/setup_step_3_code_review_status.png" alt="Trạng thái Code Review" />
    </Frame>
  </Step>
