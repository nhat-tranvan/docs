...
- **[スケジュール済みタスク](/ja/guide/automation/tasks)** でこの分析を再実行し、オンコール通知の前に問題を確認できます。
...
<CardGroup cols={2}>
  ...
  <Card title="Pulse クラスター" icon="diagram-project" href="/ja/guide/pulse/clusters">
    関連する Kubernetes シグナルをインシデントになる前にまとめる
  </Card>
  <Card title="タスクとスケジュール" icon="calendar-check" href="/ja/guide/automation/tasks">
