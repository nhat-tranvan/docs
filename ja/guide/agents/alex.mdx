...
| ドメイン | 機能 |
|--------|-------------|
| **[Optimize](/ja/guide/cost-optimization/overview)** | 支出分析、リサイジング、リザーブドインスタンス、セービングスプラン、未使用リソースの検出 |
...
<CardGroup cols={2}>
  ...
  <Card title="Optimize Findings" icon="lightbulb" href="/ja/guide/cost-optimization/recommendations">
    Alex が検証した節約機会を処理する
  </Card>
