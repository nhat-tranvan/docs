...
<Steps>
  <Step title="Code Review を開く">
    ...
    <Frame>
      <img src="/images/code-review/setup_step_1_onboarding.png" alt="Code Review オンボーディング" />
    </Frame>
  </Step>
  ...
  <Step title="セットアップを開始する">
    **Get Started with Code Review** をクリックしてセットアップウィザードを開きます。
    ...
    <Frame>
      <img src="/images/code-review/setup_step_1_setuprovider.png" alt="Code Review セットアップ - プロバイダーを選択" />
    </Frame>
  </Step>
  ...
  <Step title="プロバイダーを選択する">
    ...
    <Frame>
      <img src="/images/code-review/setup_step_1_connectprovider.png" alt="Git プロバイダーを選択" />
    </Frame>
  </Step>
  ...
  <Step title="リポジトリを選択する">
    ...
    <Frame>
      <img src="/images/code-review/setup_step_1_select_repo.png" alt="リポジトリを選択" />
    </Frame>
    ...
    **成功状態:** リポジトリが Code Review ダッシュボードに表示されます — CloudThinker がプルリクエストとマージリクエストの監視を開始しています。
    ...
    <Frame>
      <img src="/images/code-review/setup_step_1_complete_setup.png" alt="セットアップ成功" />
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="CloudThinker でステータスを確認する">
    ...
    <Frame>
      <img src="/images/code-review/setup_step_3_code_review_status.png" alt="Code Review ステータス" />
    </Frame>
  </Step>
