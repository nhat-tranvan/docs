...
| インシデントへのエスカレーション | 任意のクラスターを自動根本原因分析付きのフルインシデントに昇格させる | [Deep Response Engine](/ja/guide/incident/overview) |
...
<CardGroup cols={2}>
  ...
  <Card title="Deep Response Engine" icon="arrow-right" href="/ja/guide/incident/overview">
