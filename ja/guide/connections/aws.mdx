...
<Tabs>
  <Tab title="ロールベース（推奨）">
    ...
    <Steps>
      ...
      <Step title="接続を完了">
        ロールARNをCloudThinkerに貼り付け、必要に応じてデフォルトリージョンを選択し、**Connect**をクリックします。CloudThinkerがロールを確認し、**Connected**ステータスに変わります。
      </Step>
    </Steps>
...
| **デフォルトAWSリージョン（任意）** | 接続の開始リージョンです。エージェントはアクセス権限とユーザー指定の範囲内で他のリージョンも使用できます。 | `us-east-1` |
