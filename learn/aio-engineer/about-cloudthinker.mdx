...
1. **The engineering in this book, shipped.** The two-engine Resolve (Pulse + Resolver), a 325+ CloudSkill catalog with declared risk metadata, runbooks with typed step kinds, the Action Engine’s policy-tokenization-sandbox stack on Firecracker-isolated runtimes, and discovery-first onboarding that earns write access with evidence.
