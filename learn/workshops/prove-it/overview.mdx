...
| [Day 02 · Investigate](/learn/workshops/prove-it/day-02-investigate) | Sep 12, 2026 | Work with an agent to investigate an incident, identify the root cause, and collect evidence that validates your conclusion. | One incident report per team |
| [Day 03 · Prove It Arena](/learn/workshops/prove-it/day-03-prove-it-arena) | Sep 19, 2026 | The final challenge. Teams receive an unfamiliar cloud environment and an unexpected incident, investigate what happened, gather evidence, and defend their conclusions in front of the judges. | Revealed on the day |

Each session runs 2.5 hours around the same three blocks, **Learn**, **Practice** and **Share**. The split changes by day.

| Day | Learn | Practice | Share |
|---|---|---|---|
| Day 01 · Govern | 35 min | 95 min, break included | 20 min |
| Day 02 · Investigate | 35 min, plus a 25-minute keynote | 30 min, no break | 20 min |
| Day 03 · Prove It Arena | Revealed on the day | Revealed on the day | Revealed on the day |

## Location and teams

- **Ho Chi Minh City:** offline. **Hanoi and Da Nang:** online.
- **Teams of 1 to 4 members.** No team yet? Register individually and the organizers will match you with one.
...
<CardGroup cols={2}>
  ...
  <Card title="Day 02 · Investigate" icon="magnifying-glass" href="/learn/workshops/prove-it/day-02-investigate">
    The full Day 02 page: the noise problem, the reduction pipeline, the read-only Kubernetes lab, and what a good incident report contains.
  </Card>
  <Card title="Day 03 · Prove It Arena" icon="trophy" href="/learn/workshops/prove-it/day-03-prove-it-arena">
    The final day: the two rounds, how the judge scores a report, the attempt economy, and how to check in.
  </Card>
