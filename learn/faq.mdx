...
<AccordionGroup>
  <Accordion title="How is CloudThinker priced?">
    ...
    **Starter (Free):**
    - 20 premium credits, 5 daily credits
    - 1 workspace, 1 user
    - 3 scheduled tasks
    ...
    **Standard ($59/month):**
    - 500 premium credits, 5 daily credits
    - 3 workspaces, 3 users
    - 25 scheduled tasks
    - 500MB knowledge base storage
    - Email support

    **Advanced ($599/month):**
    - 5,000 premium credits, 5 daily credits
    - Up to 30 workspaces, unlimited users
    - 200 scheduled tasks
