...
<AccordionGroup>
  <Accordion title="What kind of support does CloudThinker provide?">
    ...
    **Starter (Free):**
    ...
    - **AI features:** [Code Review](/guide/code-review/overview), [Incident](/guide/incident/overview) RCA Analysis, Prompt Hub Query, AI Code Suggestion (coming soon), HelpDesk Ticket (coming soon)
