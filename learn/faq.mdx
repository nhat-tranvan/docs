---
title: 'FAQ'
description: 'Find answers to common questions about CloudThinker, AI agents, pricing, security, and cloud operations'
...
<AccordionGroup>
  ...
  <Accordion title="Can multiple agents work together on complex problems?">
    ...
    **Example Scenarios:**
    - **Resolve:** All agents coordinate to analyze different aspects of an outage
...
<AccordionGroup>
  <Accordion title="What kind of support does CloudThinker provide?">
    ...
    **Free:**
    ...
    - **AI features:** [Review](/guide/code-review/overview), [Resolve](/guide/incident/overview) (Pulse + RCA), Prompt Hub Query

    **Team:**
    - **Email support**
    - **AI features:** All Free features + Optimize findings + Slack Integration
    - All Free resources included

    **Scale:**
    - **99.9% SLA · email support**
    - **AI features:** All Team features + Jira Integration, SSO & Audit Log, BYOK
...
<CardGroup cols={2}>
  ...
  <Card title="Request a feature" icon="lightbulb" href="mailto:product@cloudthinker.io">
