...
<AccordionGroup>
  <Accordion title="What is CloudThinker and how does it work?">
    CloudThinker is a Multi-Agents (MAS) Orchestration platform that uses specialized AI agents to automate cloud operations. Our five expert agents - [Alex](/guide/agents/alex) (Cloud Engineer), [Oliver](/guide/agents/oliver) (Security Professional), [Tony](/guide/agents/tony) (Database Administrator), [Kai](/guide/agents/kai) (Kubernetes Administrator), and [Anna](/guide/agents/anna) (Technology Leader) - work together to optimize, secure, and manage your cloud infrastructure autonomously.
...
<AccordionGroup>
  <Accordion title="How is CloudThinker priced?">
    ...
    See the full plan comparison, credit system, and PAYG details on our [Pricing & Plans](https://cloudthinker.io/pricing) page.
  </Accordion>
  ...
  <Accordion title="How do seats work?">
    ...
    For full details on seat mechanics and minimum requirements, see our [Pricing & Plans](https://cloudthinker.io/pricing) page.
  </Accordion>
  ...
  <Accordion title="Is there a free trial or demo available?">
    ...
    **Money-Back Guarantee:** If you don't see measurable value within 30 days, we'll refund your subscription.
    ...
    For more details, see our [Pricing & Plans](https://cloudthinker.io/pricing) page.
  </Accordion>
...
<AccordionGroup>
  <Accordion title="What kind of support does CloudThinker provide?">
    ...
    **Starter (Free):**
    ...
    - **AI features:** [Code Review](/guide/code-review/overview), [Deep Response Engine](/guide/incident/overview) (Pulse + RCA), Prompt Hub Query, AI Code Suggestion (coming soon), HelpDesk Ticket (coming soon)
